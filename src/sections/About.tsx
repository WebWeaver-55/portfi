          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white">Front-End Web Developer</h3>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Bachelor of Computer Applications(BCA)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 rounded-lg p-6">
              <p className="text-white leading-relaxed">
                I'm a passionate front-end developer who loves creating beautiful and functional web applications. 
                With expertise in React, Next.js, Gsap , and modern web technologies, I focus on building scalable solutions 
                that solve real-world problems.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
                {['React', 'Next.js','Node.js', 'TypeScript', 'Gsap', 'Three.js'].map((tech) => (
                  <span key={tech} className="bg-white/20 text-white rounded-full text-sm">
                    {tech}
                  </span>
                ))}
              </div>
        ...
        >
          ...
          <div className="space-y-6 text-white">
            ...
            <p className="leading-relaxed">
              I believe in creating technology that makes a difference. Whether it's improving user experiences
              or solving complex technical challenges, I'm always excited to push the boundaries of what's possible.
            </p>
